<template>
  <div class="page_Content">
        ...
        <el-row :gutter="16">
          <el-col :span="8">
            <el-form-item label="采购单编号">
              <el-input v-model.trim="params.businessNo" placeholder="请输入采购单编号" class="input-200" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="供应商名称">
              <el-input v-model.trim="params.merchantKeyword" placeholder="请输入供应商名称" class="input-200" clearable />
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <div class="table-wrap">
      <el-tabs v-model="activeName" type="border-card" @tab-click="onChangeTabs">
  ...
  methods: {
    ...
    fetchTableData(status) {
      ...
      const params = {
        ...
        supplierMode: 'DELIVER' // 结算来源SUPPLY-采购，DELIVER-代发，SELLING-代租售
      };
    ...
    settlementAmount(row) {
      this.sourceinfo = {
        ...
        orderNum: 1,
        goodsNum: row.goodsLists.length,
    ...
    dealsettlement(row) {
      switch (
        row.settlementStrategy &&
        row.settlementStrategy.baseTimeStrategy
      ) {
        case 'RECEIPT_DATE':
          return <span>按入库时间</span>;
        case 'BILL_DATE':
          return <span>采购单提交时间</span>;
        case 'ILL_DATE':
          return <span>用户账单时间</span>;
        case 'PAYMENT_DATE':
          return <span>用户实际支付时间</span>;
      }
    },
